...
function Update()
	...
	if totalWorkspace ~= -1 then
		...
		SKIN:Bang('!SetOption WorkspaceShape Shape "Rectangle -20,0,([Workspace1:W]*'..trueTotalWorkspace..'+40),#Section_Height#,#Corner_Radius# |StrokeWidth 0 | Fill Color #Color_Scheme1#"')
	end
